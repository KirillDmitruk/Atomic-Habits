...
from habits.views import HabitListAPIView, HabitPublishListAPIView, HabitCreateAPIView, HabitRetrieveAPIView, \
...
urlpatterns = [
    ...
    path("published/", HabitPublishListAPIView.as_view(), name="habits_published"),
